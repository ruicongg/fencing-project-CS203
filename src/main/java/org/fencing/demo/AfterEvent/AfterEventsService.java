...
public class AfterEventsService {
    ...
    // Method to get AfterEvent by Event ID
    public AfterEvent getAfterEventByEventId(Long eventId) {
        return afterEventsRepository.findById(eventId)
                .orElseThrow(() -> new IllegalArgumentException("AfterEvent not found for event ID: " + eventId));
    }

    // Method to retrieve a tournament
