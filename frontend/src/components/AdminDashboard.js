...
const AdminDashboard = () => {
  ...
  const handleDeleteTournament = async (tournamentId) => {
    try {
      ...
      fetchTournaments(); // Refresh tournaments after deletion
    } catch (error) {
  ...
  const handleDeleteEvent = async (eventId) => {
    try {
      ...
      fetchTournaments(); // Refresh events after deletion
    } catch (error) {
      ...
      <div className="tournament-cards">
        ...
        {(activeTab === 'active' ? activeTournaments : completedTournaments).map(tournament => (
          <AdminTournamentCard
            ...
            onDelete={() => handleDeleteTournament(tournament.id)} // Add delete functionality here
          />
        ))}
      </div>
      ...
      {selectedTournament && (
        <div className="events-section">
          ...
          <AdminEventsList
            ...
            onDeleteEvent={handleDeleteEvent} // Pass delete function for each event
          />
        </div>
      )}
